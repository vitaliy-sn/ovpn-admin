...
var (
	...
	indexTxtPath             = kingpin.Flag("easyrsa.index-path", "path to easyrsa index file").Default(fmt.Sprintf("%s/pki/index.txt", *easyrsaDirPath)).Envar("OVPN_INDEX_PATH").String()
